        ...
        <form action="{{ route('user.post')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <textarea class="form-control" name="subtitle" id="exampleFormControlTextarea2" rows="3"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <label for="exampleFormControlTextarea1">Description</label>
                    <textarea class="form-control" name="description"  id="exampleFormControlTextarea3" rows="4"></textarea>
                </div>
            </div> 
